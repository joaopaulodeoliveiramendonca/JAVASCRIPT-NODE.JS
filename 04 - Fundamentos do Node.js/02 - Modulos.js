...
// O que são Módulos?
// Módulos são blocos de código reutilizáveis que ajudam a organizar a aplicação em partes menores.
// O Node.js possui módulos internos (nativos) que facilitam tarefas como leitura de arquivos, manipulação de caminhos e até mesmo criação de servidores HTTP.
...
// O comando require() é utilizado para importar módulos no Node.js.
// Você pode importar tanto módulos internos (como http e fs) quanto módulos externos (instalados via npm).
