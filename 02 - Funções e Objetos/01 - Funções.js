...
// Funções podem ser atribuídas a variáveis como expressões. Essas funções são chamadas de "anônimas" porque não têm um nome.
...
// Arrow Functions (() => {})
// As arrow functions oferecem uma forma mais concisa de escrever funções.
...
// Funções de ordem superior (funções que retornam funções ou recebem funções como parâmetros)
// Funções que recebem outras funções como argumento ou retornam funções são chamadas de funções de ordem superior.
