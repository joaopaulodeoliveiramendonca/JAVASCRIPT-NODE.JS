...
// 1. Create (Inserir dados) - Usamos INSERT INTO para adicionar dados ao banco.
...
// 2. Read (Ler dados) - Usamos SELECT para recuperar dados do banco.
...
// 3. Update (Atualizar dados) - Usamos UPDATE para modificar dados no banco.
...
// 4. Delete (Excluir dados) - Usamos DELETE para remover dados do banco.
...
// 1. Create (Inserir dados) - Usamos o método save() para adicionar um novo documento.
// Exemplo de inserção de um novo cliente:
...
// 2. Read (Ler dados) - Usamos o método find() para buscar documentos.
...
// 3. Update (Atualizar dados) - Usamos o método updateOne() para modificar um documento.
// Exemplo de atualização de dados de um cliente:
...
// 4. Delete (Excluir dados) - Usamos o método deleteOne() para remover um documento.
// Exemplo de exclusão de um cliente:
