...
// WebSockets permitem comunicação bidirecional entre cliente e servidor. 
// Eles são ideais para aplicações em tempo real, como chats, jogos online ou notificações em tempo real.

// Como funciona o WebSocket?
// Diferente das requisições HTTP tradicionais, que são unidimensionais (o cliente faz a requisição e o servidor responde),
// os WebSockets mantêm uma conexão aberta, permitindo que os dados sejam enviados de e para o servidor a qualquer momento.
