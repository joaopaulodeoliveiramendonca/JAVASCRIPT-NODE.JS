...
// Testes de integração verificam se diferentes partes do seu sistema (como funções ou APIs) 
// funcionam corretamente juntas. Isso é útil para verificar se a interação entre diferentes 
// componentes do sistema está funcionando como esperado.
